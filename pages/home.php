...
<link rel="stylesheet" href="../Admin-HTML/css/footer.css">
    ...
    <div class="about section">
        <div class="about-image">
			<img src="../Admin-HTML/images/uid.jpg" alt="">

        </div>
        <div class="about-content"> 
            <img src="../Admin-HTML/images/about-icon.png" alt=""><span>ABOUT MAGGOT</span>
    ...
    <div class="content-maggot">
        <div class="video-text">
            ...
            <center><p>Maggot akan siap pakai setelah melalui beberapa proses dengan tahap persiapan kandang, memancing lalat BSF, memlihara larva lalu yang terakhir memanen maggot setelah 10-14 hari dengan memisahkan dari media pakan.</p></center>    
        </div>
        <div class="video-section">
            <iframe width="1300" height="560" src="https://www.youtube.com/embed/FPALstZU7fI?si=TAW_biOOluFvxfmE" title="budidaya maggot from youtube" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
        </div>
    </div>
...
<section class="products">
    ...
    <div class="all-products">
        <div class="product">
			<img src="../Admin-HTML/images/coba 1.jpg" alt="">
            <div class="product-info">
                <h4 class="product-title">Maggot Siap Pakai</h4>
                <p class="product-price">Rp. 70.000/150gr</p>
                <a class="product-btn" href="../pages/keranjang.php">Buy Now</a>
            </div>
        </div>
        <div class="product">
            <img src="../Admin-HTML/images/produk 2.jpg" alt="">
            <div class="product-info">
        ...
        <div class="product">
           <img src="../Admin-HTML/images/coba 2.jpg" alt="">
            <div class="product-info">
        ...
        <div class="product">
           <img src="../Admin-HTML/images/coba.jpg" alt="">
            <div class="product-info">
...
<!-- FEEDBACK SECTION -->
    <section id="testimonials">
        ...
        <div class="testimonial-box-container">
                ...
                <div class="box-top">
                    ...
                    <div class="profile">
                        <div class="profile-img">
							<img src="../Admin-HTML/images/profile 1.jpg" alt="">
                        </div>
                        <div class="name-user">
            ...
            <div class="testimonial-box">
                <div class="box-top">
                    ...
                    <div class="profile">
                        <div class="profile-img">
							<img src="../Admin-HTML/images/profile  2.jpg" alt="">
                        </div>
                        <div class="name-user">
            ...
            <div class="testimonial-box">
                <div class="box-top">
                    ...
                    <div class="profile">
                        <div class="profile-img">
                            <img src="../Admin-HTML/images/profile  3.jpg" alt="">
                        </div>
                        <div class="name-user">
                ...
                <div class="box-top">
                    ...
                    <div class="profile">
                        <div class="images/profile-img">
							<img src="../Admin-HTML/images/profile  4.jpg" alt="" width="15px" height="15px">
                        </div>
                        <div class="name-user">
                            <strong>Jeno</strong>
                            <span>@Jenowrrl</span>
        ...
        <a class="testimoni-btn" href="feedback.php">Give Us Feedback</a>
    </section>
